...
function validateCard(){
      ...
      if (card.validity.valueMissing) {
            card.setCustomValidity('Select our credit card');
      }else {
...
function validateNumber(){
      ...
      if (cNum.validity.valueMissing) {
            ...
            cNum.setCustomValidity('Enter a valid vard number');
      } else if (luhn(cNum.value) === false){
            cNum.setCustomValidity('Enter a letitimate number');
      }
      else {
...
function validateCVC(){
      ...
      let card = document.forms.payment.elements.credit.value;
