...
function playDrawPoker() {
   ...
   //Create and empty poker hand object
   let myHand  = new pokerHand(5);

   //Display the current banck value
   ...
   betSelection.onchange = function(){
      ...
      if (pokerGame.currentBank >= pokerGame.currentBet) {
         ...
         //Reduce the bank by the size of hte bet
         bankBox.value = pokerGame.placeBet();

         //Get a new deck is there are less han 10 cards left
   ...
   drawButton.addEventListener("click", function() {
      ...
      //Replace cards marked to be discargded
      for (let i = 0; i < cardImages.length; i++) {
